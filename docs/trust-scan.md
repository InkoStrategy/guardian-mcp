...
Generated 2026-09-17T20:09:09.213Z. One unpaid request per endpoint to capture the x402 challenge; Pay-Safe /check-payment against the listing. No payments, no signatures.
...
| `fresh_recipient` | 4 |
| `shared_state_unavailable` | 3 |
| `endpoint_domain_suspicious` | 2 |

## Findings

- **WARN shared_state_unavailable** in Marketplace Niche Scan (sid 33278): The persistent store for threat intelligence did not answer (This operation was aborted). Shared-intel and session checks were skipped for this request.
- **WARN shared_state_unavailable** in 美股市场研究 (sid 39937): The persistent store for threat intelligence did not answer (This operation was aborted). Shared-intel and session checks were skipped for this request.
- **WARN shared_state_unavailable** in Market News (sid 40011): The persistent store for threat intelligence did not answer (This operation was aborted). Shared-intel and session checks were skipped for this request.
...
|---|---|---|---|---|
| WARN | Marketplace Niche Scan (sid 33278) | 0.1 USDT | 0.1 USDT0 on eip155:196 | shared_state_unavailable |
| WARN | 美股市场研究 (sid 39937) | 0.5 USDT | 0.5 USDT0 on eip155:196 | shared_state_unavailable |
| WARN | Market News (sid 40011) | 0.02 USDT | 0.02 USDT0 on eip155:196 | shared_state_unavailable, fresh_recipient |
