...
Generated 2026-09-18T09:00:10.057Z. One unpaid request per endpoint to capture the x402 challenge; Pay-Safe /check-payment against the listing. No payments, no signatures.
...
- **WARN eip712_domain_mismatch** in Inflation & Liquidity Signal (sid 34608): extra declares the EIP-712 domain name "USDT₀" version "1", but the USDT0 contract on xlayer uses name "USD₮0" version "1" (its DOMAIN_SEPARATOR 0xd591d9ba… matches only that pair). A TransferWithAuthorization signed with the declared domain will not verify on-chain.
...
| WARN | Inflation & Liquidity Signal (sid 34608) | 0.01 USDT | 0.01 USDT0 on eip155:196 | eip712_domain_mismatch |
...
| unreachable | Poker Eval Open (sid 39196) | 3 USDT | — | timeout |
...
| no_payment_challenge | Start Autopilot 7d (sid 40592) | 10.5 USDT | — |  |
