...
module.exports = async function handler(req, res) {
  ...
  if (method === 'GET' && apiPath === '/demo') {
    ...
    return res.end('<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>GuardianMCP Pay-Safe — demo</title><style>html,body{margin:0;background:#0b0d10;color:#e6e9ee;font:15px/1.6 system-ui,Segoe UI,Roboto,sans-serif}.w{max-width:960px;margin:0 auto;padding:24px 16px 56px}h1{font-size:22px;margin:0 0 4px}p{color:#8d96a3;margin:6px 0}video{width:100%;border:1px solid #232a33;border-radius:12px;background:#000;margin-top:12px}a{color:#6aa9ff;text-decoration:none}</style></head><body><div class="w"><h1>GuardianMCP Pay-Safe — demo (3:56)</h1><p>The current cut, self-hosted. It opens on a real AI agent trying to pay a scam listing on OKX.AI and the Guardian hook blocking it, then walks the whole flow. (YouTube re-upload of this cut pending.)</p><video id="v" controls preload="metadata" src="/demo-v61.webm"><track kind="subtitles" srclang="en" label="English" src="/demo-v61.en.vtt" default></video><p><b>Chapters:</b> <a href="#" data-t="0">0:00 a real agent blocked</a> · <a href="#" data-t="103">1:43 MCP + sid 39876 DENY</a> · <a href="#" data-t="168">2:48 live agent, unedited</a> · <a href="#" data-t="192">3:12 real settled payment</a></p><script>document.querySelectorAll("a[data-t]").forEach(function(a){a.onclick=function(e){e.preventDefault();var v=document.getElementById("v");v.currentTime=+a.getAttribute("data-t");v.play()}})</script><p>Also: <a href="/agent-runs">/agent-runs</a> (the unedited runs) · <a href="/trust">/trust</a> · <a href="/company">/company</a> · <a href="/pay-safe">/pay-safe</a> · <a href="/demo-v61.en.srt">subtitles (.srt)</a> · <a href="https://youtu.be/s8KSV2YMlyE">YouTube (older v4 cut)</a></p></div></body></html>');
  }
